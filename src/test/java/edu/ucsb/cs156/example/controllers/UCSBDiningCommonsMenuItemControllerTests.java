...
public class UCSBDiningCommonsMenuItemControllerTests extends ControllerTestCase {
    ...
    public void an_admin_user_can_post_a_new_menuitem() throws Exception {
        ...
        MvcResult response = mockMvc.perform(
                        post("/api/ucsbdiningcommonsmenuitem/post?name=chicken&diningCommonsCode=carrillo&station=grill")
                                .with(csrf()))
                .andExpect(status().isOk()).andReturn();
    ...
    @WithMockUser(roles = { "ADMIN", "USER" })
    @Test
    public void admin_tries_to_delete_non_existent_menuitem_and_gets_right_error_message()
            throws Exception {
        // arrange
