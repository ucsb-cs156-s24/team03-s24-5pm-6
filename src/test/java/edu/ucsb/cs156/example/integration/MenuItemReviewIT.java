...
public class MenuItemReviewIT {
        ...
        public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
                ...
                MenuItemReview reviews1 = MenuItemReview.builder()
                                .id(1L)
                                .itemId(121)
                                .reviewerEmail("fakeEmail1@gmail.com")
                                .stars(4)
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/menuitemreviews/post?itemId=121&reviewerEmail=fakeEmail1@gmail.com&stars=4&dateReviewed=2022-01-03T00:00:00&comments=This is amazing!")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
