...
describe("RecommendationRequestCreatePage tests", () => {
    ...
    test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
        ...
        fireEvent.change(requesterEmailField, { target: { value: 'klamar@ucsb.edu' } });
        fireEvent.change(professorEmailField, { target: { value: 'agraham@ucsb.edu' } });
        fireEvent.change(explanationField, { target: { value: 'BS/MS Degree' } });
        fireEvent.change(dateRequestedField, { target: { value: '2022-02-02T00:00' } });
        fireEvent.change(dateNeededField, { target: { value: '2022-05-02T00:00' } });
        ...
        expect(mockToast).toBeCalledWith("New recommendationRequest Created - id: 17 requesterEmail: klamar@ucsb.edu");
