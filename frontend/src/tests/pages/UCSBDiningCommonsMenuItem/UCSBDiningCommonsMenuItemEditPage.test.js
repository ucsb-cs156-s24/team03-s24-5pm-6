...
describe("UCSBDiningCommonsMenuItemEditPage tests", () => {
    ...
    describe("when the backend doesn't return data", () => {
        ...
        test("renders header but table is not present", async () => {
            ...
            expect(screen.queryByTestId("UCDBDiningCommonsMenuItem-name")).not.toBeInTheDocument();
            restoreConsole();
        });
    });
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            const dccField = screen.getByTestId("UCSBDiningCommonsMenuItemForm-diningCommonsCode");
            ...
            expect(dccField).toBeInTheDocument();
            expect(dccField).toHaveValue("carrillo");
            ...
            expect(mockToast).toBeCalledWith("menuItem Updated - id: 17 name: burger");
