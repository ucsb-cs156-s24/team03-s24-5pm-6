...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /ucsbdiningcommonsmenuitem", async () => {
        ...
        const dccInput = screen.getByLabelText("Dining commons code");
        expect(dccInput).toBeInTheDocument();
        ...
        fireEvent.change(dccInput, { target: { value: 'carrillo' } });
        ...
        expect(mockToast).toBeCalledWith("New menuItem Created - id: 3 name: chicken");
